...
const ProjectCard = (props) => {
    ...
    return (
        <div className="bg-[var(--card-dark)] rounded-[1rem] overflow-hidden mb-14 border-[2px] border-gray-600" key={id}>
            <div
                className={`flex flex-col ${id % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'
                    }`}
            >
                <div className='p-4 md:p-6 w-full lg:w-45/100'>
                    <Image
                        src={project.image}
                        width={0}
                        height={0}
                ...
                <div className='p-4 md:p-6 w-full lg:w-55/100 grid grid-cols items-center'>
                    ...
                    <div className="flex flex-wrap justify-left p-1 md:p-0 mt-1">
                        {
